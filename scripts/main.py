"""Children's health digest pipeline — entry point for GitHub Actions."""
...
def main() -> None:
    ...
    print(f"\n{'=' * 60}")
    print(f"Children's Health Digest Pipeline — {datetime.now().strftime('%Y-%m-%d %H:%M UTC')}")
    ...
    # Save digest
    digest_filename = f"Children's Health Digest — {run_date}.md"
